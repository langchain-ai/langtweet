...
async def _predict(url):
    client = get_client(url="http://localhost:51636")
...
def generate_tweet(url):
    async_func = partial(_predict, *[url], )
...
st.markdown("---")
st.markdown("Enter a URL above to generate a tweet. You can edit the generated tweet before copying and sending.")